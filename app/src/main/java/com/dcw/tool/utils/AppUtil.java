...
public class AppUtil {
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        activity.startActivityForResult(IntentUtil.getInstallAppIntent(activity, filePath), requestCode);
    }
...
//        return !DataUtil.isNullString(packageName) && packageName.equals(RxProcessTool.getForegroundProcessName(context));
//    }
    //----------------------------------------------------------------------------------------------------------------
