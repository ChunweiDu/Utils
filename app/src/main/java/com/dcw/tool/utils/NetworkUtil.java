...
public class NetworkUtil {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            MyUtils.getContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            MyUtils.getContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) MyUtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
            @SuppressLint("PrivateApi") Method getMobileDataEnabledMethod = tm != null ? tm.getClass().getDeclaredMethod("getDataEnabled") : null;
    ...
    public static void setDataEnabled(boolean enabled) {
        try {
            TelephonyManager tm = (TelephonyManager) MyUtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
            Method setMobileDataEnabledMethod = tm != null ? tm.getClass().getDeclaredMethod("setDataEnabled", boolean.class) : null;
